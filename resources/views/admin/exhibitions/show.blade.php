                ...
                <div class="md:flex md:justify-around">
                    ...
                    <div class="md:w-1/2 ml-4 flex flex-col justify-around">
                        <div>
                            ...
                            <p class="leading-relaxed">{!! nl2br(e($exhibition->description)) !!}</p>
                        </div>
                        <div class="flex justify-between">
                            <p class="title-font font-medium text-2xl text-gray-900">{{ number_format($exhibition->price) }}<span class="text-sm">円(税込み)</span></p>
                                <button onclick="location.href='{{ route('admin.exhibitions.index') }}'" class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">
                                    商品一覧へ戻る
                                </button>
                            {{-- お気に入りの追加時
